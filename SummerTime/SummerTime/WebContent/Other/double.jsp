				...
				<div class="col-md-12">
					<div class="top-section">
						<div class="profile-image">
							<%
								...
								String ClassName = (String) request.getSession().getAttribute(
										"user");
								String sql = "select * from ClassInfo where ClassName=" + ClassName
										+ "";
						...
						<div class="profile-content">
							...
							<div class="text-left">
								<a href="../jQuery/ClasschangePic.html"><span aria-hidden="true">上传头像</span></a>
		...
		<div class="top-section">
			<div class="profile-image">
				...
				<%
					...
					String sql2 = "select * from ClassInfo where ClassName=" + ClassName
							+ "";
					...
					<div class="row projects-holder">
						<%
							...
							for (int i = 0; i < photos.size() && i < 6; i++) {
								...
								out.println("<a href=\"delphoto.jsp?id="
						...
						<div class="text-right">
							<a href="waterfall.jsp"><span aria-hidden="true">查看更多&raquo;</span></a>

						</div>
						<div class="text-right">
							<a href="jqueryPhoto.jsp" target="_blank"><span aria-hidden="true">添加照片</span></a>
...
<br>
						...
						<div class="text-right">
							<a href="Artical.jsp"><span aria-hidden="true">查看更多&raquo;</span></a>
					...
					<div class="page-section" id="contact">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="text-right">
									<a href="address.jsp"><span aria-hidden="true">查看班级通讯录&raquo;</span></a>
									...
									<div class="col-md-12 text-center">
										<p class="copyright-text">
											Copyright &copy; 江苏省徐州市中国矿业大学 | 南湖校区 <a
												href="http://www.cssmoban.com/" target="_blank" title="main">首页</a>
										</p>
									</div>
								</div>
							</div>
